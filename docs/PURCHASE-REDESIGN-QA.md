...
- Available globe cells now use a luminous deep-cobalt/cyan material, view-facing blue highlight and electric Fresnel rim inspired by the supplied visual reference. Per-cell emissive lift keeps the blue legible after physical lighting is applied. The change is restricted to available inventory and lighting; sample/purchased artwork, selection colours, topology and the continent-free product direction are unchanged.
