...
- `test:visual`: 14 completed journeys at 1440×1000 and 390×844. Logo/colour cover 50, 150 and 400 cells; Paint covers creation, Clear and Undo recovery. Checks include suggested location, default Move mode, another location, review price, invalid URL rejection, valid URL confirmation, and exact committed inventory increment. It asserts that the mobile canvas ends before the panel begins and its central point is reachable.
