...
- Available globe cells now use a richer deep-cobalt/cyan material and stronger blue atmospheric rim inspired by the supplied visual reference. The change is restricted to available inventory and lighting; sample/purchased artwork, selection colours, topology and the continent-free product direction are unchanged.
