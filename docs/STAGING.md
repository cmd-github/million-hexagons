...
Latest frontend deployment (13 September 2026): `366cf92d-a64c-42d2-8716-7b604e2fe45a`, referencing immutable runtime release `6121418c93f84b0a7fd8b572f3f386de309edec9ba6bc2aefcc2d44e084374b2`. Nearby now loads exact regional anchor geometry before ranking and refreshes safely when opened; authoritative activity entries navigate to their permanent placement records. Live smoke passed activity -> placement -> tour -> upload -> Design -> Place -> Review and secure-checkout availability. Desktop/mobile Nearby, adjacent same-owner checkout lifecycle and founder milestone-planner journeys passed; screenshots were inspected. All 1,549 runtime objects were verified before deployment. The adjacent checkout test is controlled and did not create a fresh Stripe charge; physical devices remain unverified. The existing renderer remains enabled (`VITE_ARTWORK_SNAPSHOTS=false`).
