...
Latest frontend deployment (14 September 2026): `e1e5410d-db27-4e3a-b5b2-45aecdb292a6` from source commit `c86818c0`, referencing immutable runtime release `6121418c93f84b0a7fd8b572f3f386de309edec9ba6bc2aefcc2d44e084374b2`. Mobile browsers now scale the same desktop composition from a 900px layout viewport instead of 1024px, making the header, hero, globe controls and fixed right-hand creation panel about 14% larger. No mobile dock, bottom sheet, narrow camera branch or width/orientation media-query layout was reintroduced. Local 1440x900, 390x844 and 320x568 composition, globe interaction, startup and checkout-restoration checks passed; local and live screenshots were inspected. Live desktop/mobile Design -> Place -> Review -> Stripe mount/release/reload passed with zero browser errors and no payment submitted. Strict HTTPS/CDN health checks passed with cache HITs after all 1,549 runtime objects were verified. Physical iOS/Android devices remain unverified; the existing renderer remains enabled (`VITE_ARTWORK_SNAPSHOTS=false`).
