...
Latest frontend deployment (26 September 2026): `af9d3c09-ae67-4c1b-9677-21402d09a356` from source commit `786dea68` on branch `review-25-09-26`, retaining immutable runtime release `6121418c93f84b0a7fd8b572f3f386de309edec9ba6bc2aefcc2d44e084374b2`. It adds the 10,000-hexagon self-service purchase maximum and the large-request contact route (`millionhexagons@birdcagetech.com`). **The matching server enforcement is not deployed:** the Firebase credentials expired during the session, so `stagingPlacements`, `stagingCheckout` and `stripeWebhook` still accept up to 100,000 cells at quote, reservation and creation. Run `firebase login --reauth` and deploy those three to close the gap; the interface enforces the cap in the meantime. All 1,549 runtime objects, CORS, content types and cache policy verified. Roll back to `f5f9cb19-307c-4ea4-858a-4e28d8605ca2` to restore the previous front end.
