...
Latest frontend deployment (16 September 2026): `f69e6a06-69ed-47ec-a90b-80a95a4f7c04` from source commit `db77e0fa`, retaining immutable runtime release `6121418c93f84b0a7fd8b572f3f386de309edec9ba6bc2aefcc2d44e084374b2`. Create now follows Location -> Size & shape -> Design -> Review, preserving hand-drawn footprints when their exact count changes and keeping artwork colours intact on image upload. Activity/UI/Menu review changes include relative live-updating activity, quieter green/white stars, zoom-sensitive rotation and tour motion, shorter sign-in copy and inline blank-safe search. The live desktop/mobile Location -> Shape -> Design -> Review -> Stripe-mount, warm reload, startup retry and missing-asset journeys passed with no payment submitted and zero browser errors or direct Firestore requests. All 1,549 runtime objects passed deployment verification.
