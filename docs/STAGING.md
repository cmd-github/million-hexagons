...
Latest frontend deployment (13 September 2026): `05ce9cb5-252e-4cbf-9990-17224b9e169b`, referencing immutable runtime release `6121418c93f84b0a7fd8b572f3f386de309edec9ba6bc2aefcc2d44e084374b2`. Placement metadata now opens the HUD before full-footprint geometry and Nearby ranking complete, and camera travel no longer hides it. Live staging click-to-HUD measured 85 ms desktop and 76 ms mobile for the newest 2,000-cell placement; the rendered states were inspected. Controlled desktop/mobile delayed-region coverage measured 58/65 ms, and the complete persistent-checkout, adjacent-purchase, restoration and My Globe journeys remained green. All 1,549 runtime objects were verified before deployment. Physical devices remain unverified; the existing renderer remains enabled (`VITE_ARTWORK_SNAPSHOTS=false`).
