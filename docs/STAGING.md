...
Latest frontend deployment (14 September 2026): `d91bb8d2-75c4-4808-a496-c5927ff7befb` from source commit `0a4b6f61`, retaining immutable runtime release `6121418c93f84b0a7fd8b572f3f386de309edec9ba6bc2aefcc2d44e084374b2`. Sparse lime twinkles now appear on available real-cell centres after live inventory loads. The separate sprite layer fades out before close zoom and is disabled for reduced motion. Local desktop/mobile hero and close-grid browser checks passed with no page errors; focused detail and deployment tests passed. All 1,549 runtime objects passed public verification, and live health/CDN checks passed. Live desktop and phone-sized screenshots were inspected; the first desktop load showed the recoverable globe-load error, while a subsequent fresh visit loaded normally with zero page errors. Physical-device visual/performance acceptance remains open.
