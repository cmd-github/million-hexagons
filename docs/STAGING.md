...
Latest frontend deployment (14 September 2026): `52cc9f76-e525-4d07-a195-3771b5f78f36` from source commit `43197d88`, retaining immutable runtime release `6121418c93f84b0a7fd8b572f3f386de309edec9ba6bc2aefcc2d44e084374b2`. The background has 800 stable, perspective-sized hexagons in three static layers: mostly filled silhouettes, sparse crisp outlines and a slightly blurred distant layer. Local desktop/mobile composition, globe Design/navigation, deployment tests and staging build passed; mobile-emulated frame timings varied between 16.7 and 33.1 ms across sample runs, so physical-device performance remains open. All 1,549 runtime objects passed public verification, live HTTPS/CDN health passed, and inspected live desktop/mobile screenshots show the updated background alongside staging artwork. Live desktop/mobile Design -> Place -> Review -> Stripe mount/release/reload, startup retry and missing-asset checks passed with zero browser errors and no payment submitted. `VITE_ARTWORK_SNAPSHOTS=false` remains unchanged.
