...
Latest frontend deployment (15 September 2026): `0237e465-4625-4075-82e9-80606f060cea` from source commit `0dd32745`, retaining immutable runtime release `6121418c93f84b0a7fd8b572f3f386de309edec9ba6bc2aefcc2d44e084374b2`. Review now uses Preview, provides a five-row 160-character description field, hides generic Stripe identity copy when signed out and shows the signed-in email with Log out when authenticated. The landing typewriter shuffles 16 words, includes punctuation in its typing cycle and holds each completed word for three seconds. The live desktop/mobile Design -> Review -> Stripe-mount, warm reload, startup retry and missing-asset journeys passed with no payment submitted and zero browser errors or direct Firestore requests. All 1,549 runtime objects and post-deployment HTTPS/CDN checks passed with cache HITs.
