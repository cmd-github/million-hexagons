...
Latest frontend deployment (15 September 2026): `fbe8a015-0e9d-4d8b-838a-d64be4341f49` from source commit `f20b4356`, retaining immutable runtime release `6121418c93f84b0a7fd8b572f3f386de309edec9ba6bc2aefcc2d44e084374b2`. A new placement opens with zero selected hexagons, keeps globe navigation active and allows selection when the individual grid is visibly rendered. Clicking an available hexagon proposes it and Start here confirms it; Choose another spot moves the complete design intact. Used paint colours appear as reusable recent swatches. The live desktop/mobile Design -> Review -> Stripe-mount, exact reservation/release, warm reload, startup retry and missing-asset journeys passed with no payment submitted and zero browser errors or direct Firestore requests. All 1,549 runtime objects and post-deployment HTTPS/CDN checks passed with cache HITs.
