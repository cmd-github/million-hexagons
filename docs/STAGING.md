...
Latest frontend deployment (16 September 2026): `4c6e0024-882f-4bd6-884b-16a484b863a8` from source commit `e7b596d6`, retaining immutable runtime release `6121418c93f84b0a7fd8b572f3f386de309edec9ba6bc2aefcc2d44e084374b2`. Available starting hexagons can no longer fail because ten neighbours do not fit; the selection grows around purchased cells and falls back to the connected reachable count only when enclosed. Typed and preset counts contain unique available cells only. Completed purchases clear their editor draft, while unfinished work still restores. Separate live desktop/mobile 10-hexagon Location -> Shape -> Design -> Review -> Stripe-mount, reservation round-trip, warm reload, startup retry and missing-asset journeys passed with no payment submitted and zero browser errors or direct Firestore requests. All 1,549 runtime objects passed deployment verification.
