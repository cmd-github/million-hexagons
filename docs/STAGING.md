...
Latest frontend deployment (13 September 2026): `ebe32edb-e798-4088-a5f8-6ae32b45a010`, referencing immutable runtime release `6121418c93f84b0a7fd8b572f3f386de309edec9ba6bc2aefcc2d44e084374b2`. The mobile launch pass preserves 44x44 px globe controls at 320px, enlarges the Create/editor/HUD/Nearby targets, keeps the design More menu inside short viewports, and adds safe-area-aware positioning to bottom sheets, discovery surfaces and My Globe. Desktop/mobile Design -> Place -> Review, checkout reservation/release, public placement/Nearby, post-payment restoration, adjacent purchases, My Globe and account access passed. The live smoke and 320px seven-control measurement passed; rendered 320/390 states were inspected. All 1,549 runtime objects were verified before deployment. Physical iOS/Android devices remain unverified; the existing renderer remains enabled (`VITE_ARTWORK_SNAPSHOTS=false`).
