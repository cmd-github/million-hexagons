...
Exploration includes illustrative activity/global metrics, grouped HUD statistics and actions, a plain pin switch, single-button directional rotation, and slower close-range dragging. Example view counts and rankings are not production analytics.
