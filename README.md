...
Available inventory uses an almost-black midnight-blue globe treatment with a restrained cobalt hotspot and a narrow electric-blue Fresnel edge. This is a material and lighting treatment only: it does not add continent geometry or recolour advertiser artwork, purchased placements, or placement-state overlays.
