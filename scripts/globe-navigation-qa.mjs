...
for(const [width,height] of [[320,568],[390,844],[1024,768],[1440,900]]){
 ...
 await p.locator('#logoUpload').setInputFiles('scripts/fixtures/test-logo.svg');await p.waitForFunction(()=>document.querySelector('#addImageLabel').textContent==='Add another image');await p.locator('#moveImageMode').click();
