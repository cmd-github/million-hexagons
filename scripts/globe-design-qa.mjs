...
for(const mobile of [false,true]){
 ...
 await page.locator('#editHexMode').click();await page.locator('#areaBrush').selectOption('2');
 ...
 await page.locator('#removeHexMode').click();await page.locator('#areaBrush').selectOption('0');await clickCell(ids.at(-1));
